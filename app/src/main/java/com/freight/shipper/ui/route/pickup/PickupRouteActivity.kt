package com.freight.shipper.ui.route.pickup
...
import com.freight.shipper.databinding.ActivityRoutePickupBinding
import com.freight.shipper.extensions.navigateToDestinationRouteActivity
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney))
    ...
    private fun initUI() {
        setupToolbar(
            toolbar, enableUpButton = true, title = getString(R.string.arrived_at_pickup)
        )
//        setAdapter()
    }

    private fun initViewModel() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_route_pickup)
    ...
    private fun setupObservers() {
        ...
        viewModel.arrivedAtPickupAction.observe(this, Observer {
            viewModel.isLoading.set(false)
            navigateToDestinationRouteActivity(it)
            finish()
        })
