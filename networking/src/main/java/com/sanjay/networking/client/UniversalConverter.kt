...
class UniversalConverter : Converter.Factory() {
    ...
    init {
        ...
        val gsonDeserializer = FeedItemDeserializer(gson)
        val gsonConverter = GsonBuilder().registerTypeAdapter(FeedItem::class.java,
                gsonDeserializer).serializeNulls().create()
